...
describe("buildRouteControlMapView", () => {
  it("uses vehicle position as center and resolves planned stops from delivery point coordinates", () => {
    const view = buildRouteControlMapView({
      stops: [
        { id: "stop-1", route_id: "route-1", delivery_point_id: "dp-1", stop_order: 1, scheduled_time: null, status: "PENDIENTE", arrival_time: null, departure_time: null, notes: null, created_at: "", updated_at: "" },
        { id: "stop-2", route_id: "route-1", delivery_point_id: "dp-2", stop_order: 2, scheduled_time: null, status: "PENDIENTE", arrival_time: null, departure_time: null, notes: null, created_at: "", updated_at: "" },
      ],
      deliveryPoints: [
