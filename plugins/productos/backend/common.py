...
def build_action_context(request: Request, tenant_context: TenantContext) -> ProductosActionContext:
    return ProductosActionContext(
...
def audit_productos_action(
    db: Session,
    *,
    context: ProductosActionContext,
    action: str,
    entity_type: str,
    entity_id: str,
